...
function ProjectCard({ project }) {
  return (
    <motion.a
      ...
      className="group relative block overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_24px_80px_rgba(0,0,0,0.65)] backdrop-blur-xl focus:outline-none focus:ring-2 focus:ring-indigo-400/40"
    >
      <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
        ...
        <div className="absolute -bottom-28 right-0 h-64 w-64 rounded-full bg-sky-400/10 blur-3xl" />
      </div>
